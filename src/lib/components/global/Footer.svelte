		...
		<div class="flex flex-col gap-6 py-16 pb-5 border-t border-borderColor">
			<div class="grid grid-cols-4 gap-16">
				<div class="flex flex-col gap-6">
					...
					<a class="hover:text-accentHover focus:text-accentHover" href="#">Отзывы</a>
				...
				<div class="flex flex-col gap-6">
					...
					<a class="hover:text-accentHover focus:text-accentHover" href="/courses">Обучение массажу</a>
					<a class="hover:text-accentHover focus:text-accentHover" href="/courses">Online курсы</a>
				</div>
				<div class="flex flex-col justify-between">
					<div class="flex flex-col gap-6">
						<p class="text-lg">Наши подписчики в курсе всех новинок и специальных предложений</p>
						<a href="btn-dull w-full">Подписаться</a>
					</div>
					<div class="flex gap-6">
						<a class="hover:text-accentHover focus:text-accentHover" href="#">Youtube</a>
						<a class="hover:text-accentHover focus:text-accentHover" href="#">ВКонтакте</a>
						<a class="hover:text-accentHover focus:text-accentHover" href="#">Telegram</a>
					</div>
				</div>
			</div>
