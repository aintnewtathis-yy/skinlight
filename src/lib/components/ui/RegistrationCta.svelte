		...
		<div class="grid grid-cols-2 max-md:flex max-md:flex-col max-md:gap-8">
			<div class="flex flex-col gap-6 pr-16 justify-center max-lg:pr-8 max-md:pr-0 max-md:gap-4">
				...
				<p class="text-textDull w-3/4">
					...
					эксклюзивные цены и индивидуальный прайс-лист.
				</p>
                <a href="/register" class="btn-dull mt-3  max-md:mt-2">
                    Зарегистрироваться
                </a>
			</div>
            <div>
                <img class="rounded w-full h-full" src="/registrationCta.png" alt="company">
            </div>
		</div>
	</div>
</section>
